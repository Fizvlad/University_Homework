...
void Nonogram::_goTrough_ShiftIntervalsFrom (unsigned index, std::vector <unsigned short> &line, const std::vector <unsigned> &tableLine_data, std::vector <unsigned> groupsIntervals)
{
...
bool Nonogram::_goThroughLines_byDifficulty (unsigned d)
{
...
bool Nonogram::_goThroughColumns_byDifficulty (unsigned d)
{
    bool ifChanged = false;
...
bool Nonogram::_ifCorrect (const std::vector <unsigned short> &line, const std::vector <unsigned> &groups, bool ifDebug)
{
...
bool Nonogram::_ifLineCorrect (unsigned index)
{
    return _ifCorrect (_table[index], _lines_data[index]);
}

bool Nonogram::_ifColumnCorrect (unsigned index)
{
...
void Nonogram::print (bool ifBeautify, bool ifShowOnUnsolved)
{
...
unsigned Nonogram::width ()
{
    return _columns_data.size();
}

unsigned Nonogram::height ()
{
...
unsigned short Nonogram::cell (unsigned line, unsigned column)
{
    return _table[line][column];
}

Nonogram::Nonogram (const std::vector < std::vector <unsigned> > &l_data, const std::vector < std::vector <unsigned> > &c_data)
{
    _lines_data = l_data;
