...
public :
    ...
    void add(long_number* input) {
        ...
        //cout << "Summing " << print() << " and " << num->print() << endl;
        if (sign == num->sign) {
            bool extra = false;
            for (int i = 0; i < length; i++) {
                int s, sum;
    ...
    void multiple(long_number* input) {
        ...
        if (length == 1 && num->length == 1) {
            ...
            a1.fixLength();
            b1.fixLength();
            //cout << "a1 : " << a1.print() << endl << "b1 : " << b1.print() << endl;
            delete temp;
            long_number a2;
            long_number b2;
            if (num->length == 1) {
            ...
            a2.fixLength();
            b2.fixLength();
            //cout << "a2 : " << a2.print() << endl << "b2 : " << b2.print() << endl;
            delete temp;
            ...
            result.add(&s_p);
            result.add(&p_a);
            //cout << p_b.print() << " + " << s_p.print() << " + " << p_a.print() << " = " << result.print() << endl;
        ...
        fixLength();
        num->fixLength();
        //cout << "Result of " << old  << " * " << num->print() << " : " << print() << endl;
